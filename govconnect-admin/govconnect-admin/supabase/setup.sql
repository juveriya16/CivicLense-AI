-- ============================================================
-- GovConnect Admin — full database setup
-- Safe to re-run: drops any existing objects from a previous run
-- first, then recreates everything from scratch.
-- Run this whole file in the Supabase SQL Editor.
-- ============================================================

-- ------------------------------------------------------------
-- 0. Drop existing objects (children first, then parents)
-- ------------------------------------------------------------
drop trigger if exists on_auth_user_created on auth.users;
drop function if exists public.handle_new_user();

drop table if exists public.complaint_duplicates cascade;
drop table if exists public.notifications cascade;
drop table if exists public.routing_settings cascade;
...
-- ------------------------------------------------------------
-- 3. Core domain tables (complaints, duplicates, notifications, settings)
-- ------------------------------------------------------------
...
create index idx_duplicates_status on public.complaint_duplicates(status);

-- ------------------------------------------------------------
-- 5. After running this: sign up once through the app with your
--    first @gov.in address, then promote that account here:
--
